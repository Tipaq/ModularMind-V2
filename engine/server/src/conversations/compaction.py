...
class CompactionService:
    ...
    async def compact(
        ...
        Args:
            ...
            user_id: Owner user ID (unused, kept for API compat).
        ...
        conv.compaction_summary = summary_text
    ...
    @staticmethod
    async def _get_existing_summary(conv: Conversation) -> str:
        """Get the current compaction summary for this conversation."""
        return conv.compaction_summary or ""
