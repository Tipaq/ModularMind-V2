...
// Mirrors the types in @modularmind/api-client/types/engine.ts.
// Re-exported from @modularmind/ui so that platform (which depends on ui
// but NOT on api-client) can import them.
